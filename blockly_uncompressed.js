...
goog.addDependency("../../core/renderers/baseline/constants.js", ['Blockly.baseline.ConstantProvider'], ['Blockly.blockRendering.ConstantProvider', 'Blockly.utils.object']);
goog.addDependency("../../core/renderers/baseline/drawer.js", ['Blockly.baseline.Drawer'], ['Blockly.blockRendering.Drawer', 'Blockly.utils.object', 'Blockly.baseline.RenderInfo']);
goog.addDependency("../../core/renderers/baseline/info.js", ['Blockly.baseline', 'Blockly.baseline.RenderInfo'], ['Blockly.utils.object']);
goog.addDependency("../../core/renderers/baseline/renderer.js", ['Blockly.baseline.Renderer'], ['Blockly.blockRendering', 'Blockly.blockRendering.Renderer', 'Blockly.utils.object', 'Blockly.baseline.ConstantProvider', 'Blockly.baseline.Drawer', 'Blockly.baseline.RenderInfo']);
