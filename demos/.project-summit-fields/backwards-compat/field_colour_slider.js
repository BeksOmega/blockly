...
Blockly.FieldColourSlider.prototype.showEditor_ = function() {
  ...
  var hueElements = this.createLabelDom_('Color'/*Blockly.Msg.COLOUR_HUE_LABEL*/);
  ...
  var saturationElements =
    this.createLabelDom_('Saturation'/*Blockly.Msg.COLOUR_SATURATION_LABEL*/);
  ...
  var brightnessElements =
    this.createLabelDom_('Brightness'/*Blockly.Msg.COLOUR_BRIGHTNESS_LABEL*/);
