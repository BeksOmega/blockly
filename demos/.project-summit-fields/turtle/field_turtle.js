...
/* Retrieved from Blockly:
 * https://developers.google.com/blockly/
 *
 * And modified to work in the Blockly User Summit 2019 demo environment.
 */
...
CustomFields.FieldTurtle.prototype.dropdownCreate_ = function() {
  ...
  var createTextNode = function(row, text) {
    ...
    warning.setAttribute('src', 'turtle/warning.svg');
