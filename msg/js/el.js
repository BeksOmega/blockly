...
Blockly.Msg["PIECE_ALREADY_EXISTS"] = "A piece named '%1' already exists";  // untranslated
Blockly.Msg["PIECE_CREATE_PIECE_OPTION"] = "Create 'create a: %1'";  // untranslated
Blockly.Msg["PIECE_DELETE_OPTION"] = "Delete Piece '%1'";  // untranslated
Blockly.Msg["PIECE_DRAW_DRAW_MSG"] = "draw";  // untranslated
Blockly.Msg["PIECE_DRAW_OPTION"] = "Create 'draw %1'";  // untranslated
Blockly.Msg["PIECE_DRAW_TOOLTIP"] = "Draw the piece.";  // untranslated
Blockly.Msg["PIECE_DRAW_WITH_MSG"] = "with";  // untranslated
Blockly.Msg["PIECE_MUTATOR_CONTAINER_MSG"] = "properties";  // untranslated
Blockly.Msg["PIECE_MUTATOR_CONTAINER_TOOLTIP"] = "Add, remove, or reorder properties to this piece.";  // untranslated
Blockly.Msg["PIECE_MUTATOR_NAME_MSG"] = "property name:";  // untranslated
Blockly.Msg["PIECE_MUTATOR_TOOLTIP"] = "Add a property to the piece.";  // untranslated
Blockly.Msg["PIECE_OBJECT_CREATE_MSG"] = "add";  // untranslated
Blockly.Msg["PIECE_OBJECT_END_MSG"] = "to list";  // untranslated
Blockly.Msg["PIECE_OBJECT_TOOLTIP"] = "Add a new piece to the list.";  // untranslated
Blockly.Msg["PIECE_OBJECT_WARNING"] = "'create piece' blocks don't belong here, try putting them in a 'replace piece' or 'start list' block.";  // untranslated
Blockly.Msg["PIECE_PROPERTY_DEFAULT_NAME"] = "x";  // untranslated
Blockly.Msg["PIECE_PROPERTY_OPTION"] = "Create 'get %1'";  // untranslated
Blockly.Msg["PIECE_PROPERTY_TOOLTIP"] = "A property of a piece.";  // untranslated
Blockly.Msg["PIECE_PROPERTY_WARNING"] = "There isn't a property with that name for this piece, try putting it inside the block you created it with.";  // untranslated
Blockly.Msg["PIECE_REPLACE_OPTION"] = "Create 'replace %1'";  // untranslated
Blockly.Msg["PIECE_REPLACE_REPLACE_MSG"] = "replace";  // untranslated
Blockly.Msg["PIECE_REPLACE_TOOLTIP"] = "Replace the piece with new pieces.";  // untranslated
Blockly.Msg["PIECE_REPLACE_WITH_MSG"] = "with";  // untranslated
Blockly.Msg["PIECE_START_REPLACE_MSG"] = "replace list";  // untranslated
Blockly.Msg["PIECE_START_START_MSG"] = "start list =";  // untranslated
Blockly.Msg["PIECE_START_TIMES_DRAW_MSG"] = "times, and draw";  // untranslated
Blockly.Msg["PIECE_START_TOOLTIP"] = "The list of start pieces, and how many time to replace them.";  // untranslated
...
Blockly.Msg["TURTLE_CLEAR_MSG"] = "clear canvas";  // untranslated
Blockly.Msg["TURTLE_CLEAR_TOOLTIP"] = "Erase all of the drawing from the canvas.";  // untranslated
Blockly.Msg["TURTLE_COLOUR_MSG"] = "set line colour to";  // untranslated
Blockly.Msg["TURTLE_COLOUR_TOOLTIP"] = "Set the colour of the draw line.";  // untranslated
Blockly.Msg["TURTLE_DEGREES"] = "°";  // untranslated
Blockly.Msg["TURTLE_FORWARD_MSG"] = "move forward";  // untranslated
Blockly.Msg["TURTLE_FORWARD_TOOTLIP"] = "Move the turtle forward.";  // untranslated
Blockly.Msg["TURTLE_GET_COLOUR_MSG"] = "current colour";  // untranslated
Blockly.Msg["TURTLE_GET_COLOUR_TOOLTIP"] = "Get the colour of the draw line.";  // untranslated
Blockly.Msg["TURTLE_GET_WIDTH_MSG"] = "current width ";  // untranslated
Blockly.Msg["TURTLE_GET_WIDTH_TOOLTIP"] = "Get the width of the draw line.";  // untranslated
Blockly.Msg["TURTLE_HUE"] = "120";  // untranslated
Blockly.Msg["TURTLE_LEFT_MSG"] = "turn left ↺";  // untranslated
Blockly.Msg["TURTLE_LEFT_TOOLTIP"] = "Rotate the turtle left.";  // untranslated
Blockly.Msg["TURTLE_PEN_DOWN_MSG"] = "pen down ✎";  // untranslated
Blockly.Msg["TURTLE_PEN_DOWN_TOOLTIP"] = "Set the turtle's pen down so it can draw.";  // untranslated
Blockly.Msg["TURTLE_PEN_UP_MSG"] = "pen up ✐";  // untranslated
Blockly.Msg["TURTLE_PEN_UP_TOOLTIP"] = "Stop the turtle from drawing until you set the pen down again.";  // untranslated
Blockly.Msg["TURTLE_RESTORE_STATE_MSG"] = "restore turtle state from stack";  // untranslated
Blockly.Msg["TURTLE_RESTORE_STATE_TOOLTIP"] = "Apply the last saved position, rotation, line width, and line colour to the turtle. This will remove the turtle state from the stack.";  // untranslated
Blockly.Msg["TURTLE_RIGHT_MSG"] = "turn right ↻";  // untranslated
Blockly.Msg["TURTLE_RIGHT_TOOLTIP"] = "Rotate the turtle right.";  // untranslated
Blockly.Msg["TURTLE_SAVE_STATE_MSG"] = "add turtle state to stack";  // untranslated
Blockly.Msg["TURTLE_SAVE_STATE_TOOLTIP"] = "Save the position, rotation, line width, and line colour of the turtle.";  // untranslated
Blockly.Msg["TURTLE_WARNING"] = "Turtle blocks don't belong here, try putting them in a 'draw piece' block.";  // untranslated
Blockly.Msg["TURTLE_WIDTH_MSG"] = "set line width to";  // untranslated
Blockly.Msg["TURTLE_WIDTH_TOOLTIP"] = "Set the width of the draw line.";  // untranslated
